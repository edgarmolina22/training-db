...
const WEEKS = [
  ...
  // PHASE 2 — REBUILD
  {
    num:3, phase:'rebuild', dates:'May 25–31', miles:26, note:'Race week — San Jose Half Marathon on Sunday. Keep all runs easy leading in. Treat the race as a hard training effort, not a peak performance.',
    ...
    days:[
      ...
      { name:'Sat', type:'rest', title:'Rest day', detail:'Full rest. Stay off your feet as much as possible. Light stretching, early dinner, early bed. Everything is ready — trust your preparation.', stats:'Rest · race eve' },
  ...
  },
  {
    ...
    days:[
      { name:'Mon', type:'rest', title:'Rest day', detail:'Off your feet as much as possible. No workout.', stats:'Rest' },
      ...
      { name:'Thu', type:'rest', title:'Rest day', detail:'Full rest. Prepare gear, finalize nutrition. Early dinner, early bed tonight and Friday.', stats:'Rest · prep day' },
      ...
      { name:'Sat', type:'rest', title:'Rest day', detail:'Full rest. Gear laid out, nutrition plan confirmed, early dinner, early bed. Your fitness is locked in — nothing you do today can help you, but plenty can hurt you. Sleep is the last performance enhancer.', stats:'Rest · race eve · Aug 22' },
